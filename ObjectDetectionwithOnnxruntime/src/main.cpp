...
int main(int argc, char* argv[])
{
    ...
    bool isGPU = true;
    const std::string classNamesPath = "F:/learning/OnnxDeployment/deployment/deployment/models/coco.names";
    const std::vector<std::string> classNames = utils::loadNames(classNamesPath);
    const std::string imagePath = "F:/learning/OnnxDeployment/deployment/deployment/images/bus.jpg";
    const std::string modelPath = "F:/learning/OnnxDeployment/deployment/deployment/models/yolov5s.onnx";
